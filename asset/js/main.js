...
var attemptArray=[];
    ...
    for(i in array){
        document.getElementById(array[i]).style.background="url('asset/images/diamond.png')";
        ...
        if(markedArray.indexOf(id)== -1) {
            if(document.getElementById(id).style.backgroundColor=="red"){
                ...
                for(i in attemptArray){
                    document.getElementById(attemptArray[i]).innerHTML="<img id='img"+attemptArray[i]+"' src='asset/images/white.png' height='100%' width='100%'>";
                }
                for(i in markedArray){
                    document.getElementById(markedArray[i]).innerHTML="<img id='img"+attemptArray[i]+"' src='asset/images/diamond.png' height='100%' width='100%'>";
                }
                var result=10;
                var closeDirection="";
                for(i=1;i<8;i++){
                ...
                if(closeDirection=="R"){
                    document.getElementById(id).innerHTML='<img src="asset/images/right.jpg" width="100%" height="100%">'; 
                }else if(closeDirection=="L"){
                    document.getElementById(id).innerHTML='<img src="asset/images/left.jpg" width="100%" height="100%">'; 
                }else if(closeDirection=="T"){
                    document.getElementById(id).innerHTML='<img src="asset/images/up.png" width="100%" height="100%">'; 
                }else if(closeDirection=="B"){
                    document.getElementById(id).innerHTML='<img src="asset/images/down.png" width="100%" height="100%">'; 
                }
